...
-- 3. change the status of the movie upon returning  
DELIMITER //
...
CREATE USER  manager IDENTIFIED BY '007Bond';
GRANT ALL ON video_rental.* TO manager;

-- create user 'Sara',  grant specific privileges
CREATE USER Sara IDENTIFIED BY '002Sara';
...
CREATE USER Tom IDENTIFIED BY '003Tom';
